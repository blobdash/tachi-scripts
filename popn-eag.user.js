// ==UserScript==
// @name         Eagle pop'n Score Exporter
// @version      0.3
// @description  Export pop'n scores from Eagle. Based off a script by Meta-link and Humanbomb.
// @author       blobdash
// @match        https://eagle.ac/game/pnm/*
// @exclude      https://eagle.ac/game/pnm/*/scores
// @exclude      https://eagle.ac/game/pnm/*/custom
// @exclude      https://eagle.ac/game/pnm/*/players
// @icon         https://www.google.com/s2/favicons?sz=64&domain=eagle.ac
...
function exportScores(scores){
    const json = {
            "meta": {
                "game": "popn",
                "playtype": "9B",
                "service": "EAG pop'n Music Exporter"
            },
            scores: scores
    };
